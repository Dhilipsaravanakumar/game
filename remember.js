...
var highscore = parseInt(localStorage.getItem("dsk-remember-highscore")) || 0; //tracks highscore, restored from a previous session if present
...
// show the restored high score as soon as the game page loads
...
function startOver() {
  if(level > highscore){
    ...
    localStorage.setItem("dsk-remember-highscore", highscore);
  }
  level = 0;
  gamePattern = [];
  started = false;
